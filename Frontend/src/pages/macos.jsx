  ...
  return (
    <div className="flex min-h-[50vh] w-full flex-col items-center px-4 pt-32 text-xl sm:px-6 md:pt-40 lg:pt-24">
      <div className="w-full max-w-5xl text-center">
        <p className="bg-red-700 bg-clip-text text-2xl font-semibold text-transparent sm:text-4xl lg:text-[30px]">
          macOS Tahoe
        </p>
      ...
      <div className="mt-8 flex w-full justify-center mt-[120px]  lg:mb-20">
        <img
          src={mac}
          alt="macOS Tahoe preview"
          className="w-full max-w-[360px] object-contain sm:max-w-4xl lg:max-w-5xl"
        />
      </div>
    </div>
  )
